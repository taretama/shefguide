...
| ---------------- | ------: | --------------------------------------------------------------------------------------------------------- |
| Layout variance  |    7/10 | Use asymmetric editorial compositions and clear reading paths rather than repeated uniform card grids.    |
| Motion intensity |    2/10 | Use only short state changes and one understated entrance treatment. Never use decorative looping motion. |
| Visual density   |    5/10 | Make information comfortably scannable and keep generous space around orientation moments.                |
